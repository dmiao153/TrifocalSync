...
first_filtering = datacounts > (0.013 * n^2);
...
load("Photo_Tourism_cleaning/Roman_Forum/Roman_Forum_newindices.mat")
...
diary Photo_Tourism_cleaning/Roman_Forum/output.log
