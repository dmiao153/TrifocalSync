...
first_filtering = datacounts > (0.05 * n^2);
first_filtering = find(first_filtering);
if length(first_filtering) > 200
    [~,first_filtering]  = maxk(datacounts, 200);
end
...
% load("Photo_Tourism_cleaning/Madrid_Metropolis/Madrid_Metropolis_newindices.mat")
...
diary Photo_Tourism_cleaning/Madrid_Metropolis/output.log
